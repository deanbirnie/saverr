...
import { addIncomeItem } from "../../api-requests/itemAPI.js";
import PropTypes from "prop-types";

export default function AddIncomeItemForm({ budgetId, categoryId, onAddItem }) {
  ...
  const handleSubmitForm = async (e) => {
    e.preventDefault();
    try {
      const newItem = await addIncomeItem(
        itemName,
